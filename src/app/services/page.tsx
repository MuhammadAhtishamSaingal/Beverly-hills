  ...
  const categories: ServiceCategory[] = [
    ...
    },
    {
      ...
      procedures: [
        ...
        {
          name: "Plasma Fibroblast Treatment",
          desc: "Micro-plasma energy therapy to tighten eyelids, neck, and loose facial skin.",
          duration: "60 - 90 mins",
        ...
        {
          name: "Botox: Face, Neck, Anti-Wrinkles",
          desc: "Neurotoxin injections to smooth expression lines, soften neck bands, and prevent wrinkles.",
          duration: "15 - 30 mins",
          suitability: "Prevention and reduction of dynamic wrinkles",
        },
        {
          name: "PRP: Face, Hair, TMJ Joint, Arthritis",
          desc: "Platelet-Rich Plasma therapy using your own growth factors to heal joints, grow hair, or refresh skin.",
          duration: "60 mins",
        ...
        {
          name: "PDO Threads Lift: Face, Neck, Body",
          desc: "Absorbable suture threads inserted under the skin to physically lift, support, and stimulate collagen.",
          duration: "60 - 90 mins",
