...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-screen flex items-start md:items-center justify-start overflow-hidden bg-brand-primary pt-[26vh] md:pt-0 pb-12 md:pb-0">
